...
Em 1996 nascia o Bate-Papo UOL e, aos poucos, a minha interação com o computador do meu tio passou a se dar pela internet. Meu primo me apresentou aquele novo universo e a linguagem utilizada nas salas.

Talvez eu deva um pedido de desculpas ao meu tio por algum inconveniente causado naquela época, mas acredito que ele compreendia a vontade de ver o novo.

## Meu primeiro computador

![Desktop View](/assets/img/posts/k6-2.jpg){: width="300" height="300" .right}
Em 1999 eu estava na 4a série do ensino fundamental, não sei bem qual é o equivalente de hoje em dia. Consegui convencer a minha mãe a me dar um computador e o meu primo Danetto, que nessa época cursava Engenharia da Computação, nos acompanhou na empreitada. Da configuração da máquina eu só me recordo do processador, um K6-2 da AMD que alcançava incríveis 550MHz. O monitor era um Samsung SyncMaster 750s.

O meu primeiro sistema operacional foi o Windows 98. Posteriormente, atualizei para o Windows Millenium e esse era o máximo que a minha máquina suportava com um relativo conforto. O Windows XP, lançado em 2001, era o meu sonho de consumo, mas ele era muito pesado para o meu K6-2.

Passei a formatar o HD com uma certa regularidade para fazer testes. Instalava o Windows XP e voltava para o Millenium. Quanto a máquina ficava cheia demais também formatava para começar novamente. Nessas idas e vindas comecei a compreender melhor como que o computador funciona, suas partes internas e demais procedimentos. Acabei gravando na memória "serial numbers" cujas sequencias iniciais estão até hoje na minha memória.

![Desktop View](/assets/img/posts/winamp.jpg){: width="300" height="300" .left}
Tive contato com toda a sequência de programas de computador que acabaram por revolucionar a indústria da música, como o Napster, eMule, SoulSeek, Limewire, Kazaa e demais. O Napster foi o primeiro que eu usei e lembro até hoje da sensação de novidade ao baixar músicas que antes eu só tinha acesso por discos de vinil ou CD. Destes programas, os que eu mais gostei foram o SoulSeek e o eMule. Aquela skin original do Winamp nunca vai sair da minha memória.
...
Outro grande interesse meu na época era o aquarismo. Meu primo Danetto queria registrar um domínio para fazer testes na web para a faculdade e eu sugeri que fizéssemos um site sobre aquerismo. Ele então registrou o domínio "peixevivo.com" e me deu acesso.

![Desktop View](/assets/img/posts/phpBB.png){: width="500" height="500" .right}
Me lembro com clareza do cPanel do site e como era fácil criar serviços naquele contexto, como fóruns utilizando o phpBB.

Comecei a usar o então Macromedia DreamWeaver, hoje da Adobe, para criar páginas. Sempre tive facilidade de pegar modelos prontos e adaptar para as minhas necessidades. Criei várias páginas para brincadeiras com os amigos do Setor Jaó em Goiânia e as hospedava no "hpg.com.br".

No entanto, somente conseguia criar páginas estáticas. Ouvi falar que a criação de páginas dinâmicas estava sendo feita com a linguagem de programação PHP, então comprei um livro que eu acredito ser "PHP a Bíblia". Péssima maneira para se começar a aprender uma linguagem de programação. A falta de uma base anterior, sobretudo em lógica de programação em geral, acabou me levando ao desinteresse e deixei o PHP de lado.
...
O Bate-Papo UOL foi legal, mas não me prendia. Tentei usar o ICQ durante um tempo, mas achava estranha aquela lógica de ter um identificador numérico, além de ninguém usar, somente uma prima minha.

Então, não sei bem como ou porque, fui apresentado ao mIRC por volta de 2002. De repente, todos os meus amigos do bairro e da escola também estavam usando e eu podia, efetivamente, conversar com "pessoas reais" na internet.
...
Encontrei alguns "addons" para o mIRC, complementos com funcionalidades específicas que me interessavam, sobretudo na parte gráfica, e comecei a fazer o meu próprio script. Ele era bem interessante e alguns amigos usavam. Os "@"s dos OP's do canal e os "+"s dos voices eram prateados, em vez do texto comum dos outros scripts. O nome dele era "fX Script", mas, infelizmente, as únicas cópias que eu tinha estavam gravadas em DVD's na casa da minha mãe e estes foram furtados em 2008. Aprendi mIRC Scripting Language com uma certa facilidade, mas não tinha proficiência para escrever um código "do zero", sempre partia de um exemplo e ia adicionando e alterando funcionalidades para atender meus interesses.

Fiz vários amigos no mIRC, pessoas que convivi pessoalmente durante anos, encontrei em festas e vários outros eventos. o mIRC em Goiânia, tendo conversado com pessoas de outros estados que me relataram como era a adesão em suas cidades, teve uma força muito grande. Cheguei a ser OP do #inflamado, canal relevante entre os jovens de Goiânia, e alguns outros.

Do ponto de vista tecnológico, acessei vários canais importantes: #hacker, #phreaking, #digratis e outros em inglês da Rede EFnet. Aprendi muito conversando e acompanhando as conversas dos canais sobre os mais variados assuntos. Sinto falta desta forma de comunicação em grupo. Não acredito que grupos no Facebook, grupos do telegram Telegram ou mesmo canais do Discord sejam equivalentes. O mIRC naquela época tinha uma aura de entusiasmo que eu não presenciei em nenhum outro meio de comunicação ou rede social posterior. Tenho razões suficientes para afirmar que essa percepção não é mero saudosismo, porque me lembro com clareza da dinâmica das conversas. Talvez a sensação de frescor das interações online tenha se esvaido ao longo da sequencia de redes sociais.

O período de transição do mIRC para o MSN foi interessante. Nessa época eu já tinha um computador melhor e o uso de computadores em redes domésticas para jogos como Counter Strike estava em alta. Quebrei a cabeça com os amigos para jogar em rede na casa de alguém no final de semana e a experiência foi bem legal. Por outro lado, escutei recentemente uma reflexão que tendo a concordar: tínhamos mais liberdade na internet quando eram desenvolvidos protocolos, como o IRC, e cada um os implementava da maneira que queria, sem uma autoridade centralizadora de código fechado, como vemos hoje em dia nas redes sociais.

# Apple, Música e Fotografia
No período compreendido entre 2003 e 2006 eu estava interessado em música eletrônica e busquei uma forma de compreender como aquele universo funcionava, sobretudo como produzir psytrance. Aos poucos montei um home studio e comecei os estudos de produção musical no software Steinberg Cubase. Fiz algumas coisas bem amadoras e logo cheguei à conclusão de que o melhor caminho possível a ser seguido para lidar com as necessidades inerentes à manipulação de áudio em computadores, eu precisava de um MacBook.

Em 2007 ingressei no curso de Direito da Pontifícia Universidade Católica de Goiás (PUC-GO). O tempo se passou e só consegui comprar o MacBook por volta de 2009, quando o interesse em produção musical já estava para trás, mas pude me inteirar com profundidade sobre o uso do Logic Pro.

De 2009 até 2014 eu usei exclusivamente Macintosh. Em 2012, quando estava morando na Austrália, comprei um MacBook Pro e o foco era fotografia. Gostei de aprender a usar o Lightroom.

Nesse período não me interessei por programação.
...
Nos anos iniciais na Receita Federal atuei em áreas mais vinculadas ao Direito Tributário, mas em 2017 passei a utilizar um software interno chamado ContÁgil[^fn-nth-4] que permite várias possibilidades interessantes. O objetivo desta aplicação, que na verdade é um grande framework, é integrar as inúmeras fontes de dados em um só lugar e oferecer ferramentas de processamento otimizadas à auditoria tributária.
...
Em 2018, antes do meu primeiro filho nascer, tive um tempo extra e estudei alguns conceitos que haviam ficado para trás. Fiz um curso básico de lógica de programação, outro de SQL e outro de JavaScript. JavaScript definitivamente não chamou a minha atenção, mas gostei dos conceitos de SQL.
...
Ainda nessa época eu fiz uma primeira investida em Python. Dei os passos iniciais, acompanhei o curso do Guanabara no YouTube, mas não cheguei a ir muito longe, talvez pela falta de um projeto específico para me dedicar. Não sou bom em aprender linguagens de programação de forma abstrata, aprendo mais se pego os conceitos iniciais e parto logo para um projeto prático que exija de mim contornar os desafios.

Na Receita Federal havia uma necessidade crescente de Cientistas de Dados e Engenheiros de Dados. Eu vinha me interessando por esses assuntos, mas sem muito compromisso. Em 2020 resolvi aprender Python de verdade. Fiz o curso "Fundamentos de Linguagem Python Para Análise de Dados e Data Science" da Data Science Academy e alguns outros focados em Python e Ciência de Dados que encontrei na Udemy.
...
O primeiro desafio foi escrever um script em Jython que acessasse um determinado sistema da Receita Federal para coletar dados em lote. Publiquei o script dentro do ContÁgil e até hoje ele é utilizado diariamente por dezenas de pessoas pelo Brasil.
...
Considerando-se que o módulo de cadastro é o eixo central do sistema, cujos dados seriam referenciados pelos outros modelos, acabei por estudar as necessidades de infraestrutura que  teríamos que abordar para colocar o sistema em produção. Nessa época, nada sabia docker, Linux, web servers e gerenciamento de banco de dados. Assim, fui estudando cada uma das tecnologias necessárias para se colocar um sistema em produção em uma VM Linux.

Acabei me interessando pelo Linux e comprei um computador para fazer alguns testes em casa. Fiquei impressionado com a qualidade gráfica do Linux com o Gnome. Depois de muitos anos acostumado a usar Macintosh achei o polimento do Gnome muito bom. Gosto muito do Fedora, mas acho que o Ubuntu tem oferecido um ambiente mais estável para quem precisa desenvolver software. Estou migrando o servidor que gerencio hoje em dia do CentOS 7 para o Rocky Linux 9, e nos containers do docker geralmente eu gosto de usar o Debian.

Os desafios do projeto foram muitos, a começar por como configurar o nginx para fazer o proxy reverso para o sistema e chamar o certificado digital (hardware security module) do usuário para ser autenticado pelo Django. Foram muitas horas de debug, muitos dias de trabalho até tarde, mas aprendi que se você quebrar um problema grande em vários problemas pequenos e ir resolvendo um a um, é possível se alcançar bons resultados. Nesse caminho, que durou de 2021 a 2023, aprendi muito sobre várias tecnologias e o sistema foi bem aceito pelos colegas de todo o Brasil. Ficamos em 2º lugar no Prêmio Criatividade e Inovação[^fn-nth-10] da Receita Federal.

Estava sentindo falta de lidar mais com o Direito Tributário e tive a oportunidade de ser designado julgador da Delegacia de Julgamento da Receita Federal do Brasil em Salvador (DRJ05). Trata-se de uma delegacia especializada em julgar, em primeira instância administrativa, os recursos apresentados pelos contribuintes contra autos de infração e despachos decisórios emitidos por Auditores-Fiscais.
...
# Rust
Em 2024 comecei a estudar Rust. Fui pesquisar os benchmarks de frameworks para desenvolvimento web e notei que os mais performáticos eram escritos em Rust. Já vinha pensando em estudar outra linguagem, de preferência de mais baixo nível e compilada, e Rust me pareceu uma proposta interessante.

Li o livro oficial[^fn-nth-11] da linguagem e alguns outros para me inteirar dos conceitos novos, sobretudo por tratar-se de uma linguagem fortemente tipada e não orientada a objetos.
...
Pesquisei o assunto várias semanas e não encontrei nada pronto[^fn-nth-12]. Depois de muito estudar o assunto, deixá-lo de lado algumas semanas e aprofundar o meu entendimento sobre Arc e Mutex[^fn-nth-13] e sobre os traits relativos ao crate rustls[^fn-nth-14], cheguei a uma solução[^fn-nth-15] que abre portas para avançar em novos horizontes. Achei interessante que eu estava escutando o podcast "Rust in Production" com o Eric Seppanen[^fn-nth-16] sobre o uso da linguagem na empresa Matic e ele mencionou que um dos edge cases não resolvidos que ele havia encontrado no ecosistema era justamente a necessidade de se estabelecer um contexto TLS com certificados digitais no lado do cliente.
...
Ganhei o meu primeiro computador há 25 anos e esse acontecimento moldou muitos aspectos da forma que eu enxergo o mundo. Hoje em dia, sobretudo com o excesso de informação disponível, mostra-se cada vez mais necessário ter clareza de onde a pessoa quer chegar e o quê ela quer aprender. As riminiscências das linhas acima são um exercício de compreensão de um processo longo e complexo, mas me dão mais confiança para seguir estudando e enfrentando novos desafios.
...
[^fn-nth-3]: Leonardo Paula aprovado na colocação 23º do concurso Receita Federal . <https://www.tecconcursos.com.br/depoimentos/leonardo-de-paula-23-colocado-auditor-fiscal-da-receita-federal-2014>

[^fn-nth-4] ContÁgil. <https://www.youtube.com/watch?v=CCPXtEyoph8>

[^fn-nth-5] Curso Python. <https://www.youtube.com/watch?v=S9uPNppGsGo&list=PLHz_AreHm4dlKP6QQCekuIPky1CiwmdI6>

[^fn-nth-6] https://www.datascienceacademy.com.br/course/fundamentos-de-linguagem-python-para-analise-de-dados-e-data-science

[^fn-nth-7] https://www.djangoproject.com/

[^fn-nth-8] https://github.com/ColorlibHQ/AdminLTE

[^fn-nth-9] https://ea.ufba.br/wp-content/uploads/2023/09/Resultado-Preliminar-do-22-Premio-Criatividade-e-Inovacao-RFB_a.pdf

[^fn-nth-10] https://doc.rust-lang.org/book/

[^fn-nth-11] https://github.com/rustls/rustls/issues/341

[^fn-nth-12] https://itsallaboutthebit.com/arc-mutex/

[^fn-nth-13] https://docs.rs/rustls/latest/rustls/

[^fn-nth-14] https://github.com/leonardodepaula/Cryptoki-TLS

[^fn-nth-15] 37:00. https://open.spotify.com/episode/6Vgr3FE2X6IVAFAJ4UnZcR?si=cdc145c808db4a97